...
const writeUsers = fs.createWriteStream('./csv/postgresUsers.csv');
...
const writeListings = fs.createWriteStream('./csv/postgresListings.csv');
...
const writeBookings = fs.createWriteStream('./csv/postgresBookings.csv');
